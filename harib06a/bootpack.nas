...
_HariMain:
	...
	PUSH	2555928
	MOV	DWORD [-884+EBP],0
	MOV	DWORD [-880+EBP],1073741824
	MOV	DWORD [-996+EBP],0
	MOV	DWORD [-992+EBP],1073741824
	CALL	_set_segmdesc
	...
	MOV	DWORD [-1060+EBP],_task_b_main
	MOV	DWORD [-1056+EBP],514
	MOV	DWORD [-1052+EBP],0
	MOV	DWORD [-1048+EBP],0
	MOV	DWORD [-1044+EBP],0
	MOV	DWORD [-1040+EBP],0
	MOV	DWORD [-1036+EBP],EBX
	MOV	DWORD [-1032+EBP],0
	MOV	DWORD [-1028+EBP],0
	MOV	DWORD [-1024+EBP],0
	MOV	DWORD [-1020+EBP],8
	MOV	DWORD [-1016+EBP],16
	MOV	DWORD [-1012+EBP],8
	MOV	DWORD [-1008+EBP],8
	MOV	DWORD [-1004+EBP],8
	MOV	DWORD [-1000+EBP],8
L31:
	ADD	ESP,20
L2:
	LEA	ESI,DWORD [-44+EBP]
...
L35:
	...
	CMP	EBX,339
	JG	L8
	MOV	AL,BYTE [_keytable-256+EBX]
	TEST	AL,AL
	JE	L8
	CMP	DWORD [-1132+EBP],143
	JG	L8
	PUSH	1
	MOV	BYTE [-92+EBP],AL
	PUSH	ESI
